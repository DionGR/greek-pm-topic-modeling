...
class GreekPMDataloader:
    ...
    CATEGORIES = ["statements", "speeches", "letters", "articles", "addresses", "op-eds-interviews", "press-releases",
                  "press-conferences"]
    DATA_PATH = "./data/"
    ...
    def load_categories(self, *categories: List[str]):
        ...
        for category in categories:
            ...
            articles_data = self.scraper.run(category, data_path=self.DATA_PATH)
